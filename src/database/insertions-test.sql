...
INSERT INTO ficha (id_usuario, id_exercicio, series, repeticoes)
VALUES 
    (1, 1, 3, 12),  -- Thalysson, Rosca direta, 3 séries de 12 repetições
    (1, 3, 4, 10),  -- Thalysson, Supino reto, 4 séries de 10 repetições
    (2, 2, 4, 8),   -- João Silva, Desenvolvimento, 4 séries de 8 repetições
    (2, 5, 3, 15),  -- João Silva, Tríceps testa, 3 séries de 15 repetições
    (3, 4, 5, 12),  -- Maria Oliveira, Puxada frontal, 5 séries de 12 repetições
    (3, 7, 4, 10);  -- Maria Oliveira, Leg press, 4 séries de 10 repetições